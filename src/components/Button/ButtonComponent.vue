...
<template>
  ...
  <button :class="[
    ...
    props.customClass
  ]" @click="click ?? (props?.route && router.push(props.route))" :disabled="loading">
  <span v-if="loading">
    <svg aria-hidden="true" :class="['inline w-8 h-8 text-white/30 animate-spin fill-white', props.customClassLoad]" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
