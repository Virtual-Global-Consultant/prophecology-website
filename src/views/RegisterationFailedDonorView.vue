        ...
        <template v-slot:pages>
            ...
            <RightCard class="!py-9 space-y-6">
                <template v-slot:content>
                    <p class="font-TruenoB text-xl w-11/12">Sorry! One or more information provided below are not matched in our system</p>
                   <div class="flex space-x-6 w-fit">
                        <p class="border border-red-200 p-3 rounded-md">Donor ID: <span class="font-bold">015214564</span></p>
                   </div>
                    <p class="w-9/12 !mb-10 text-dim-gray">Don't worry, Still you can create your account with your first and last name</p>
                    ...
                    <Button name="Create Account" class="w-6/12 px-3" />
