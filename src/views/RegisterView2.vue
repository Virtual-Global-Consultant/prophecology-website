            ...
            <RightCard class="!py-9 xl:h-fit">
                <template v-slot:content>
                    <div class="border rounded-md mb-3">
                        ...
                        <p class="px-4 py-2 text-xs xl:w-fit w-[72%]">Are the above Information representing you? If not please
                            <button
                                ...
                                @click="$router.push('/')">Change Here</button></p>
                    </div>

                    <div>
                        <InputLabelComponent label="Username*" for="username" placeholder="Enter Your User Name" />
                        <InputLabelComponent label="Email Address*" for="email" placeholder="Enter Your Email Address" />
                    </div>
                    <div class="relative">
                    ...
                    <div class="flex items-center justify-between mt-5">
                        <Button name="Create Account" class="w-fit !text-xs !p-3" route="/register-success"/>
                        <p><span class="text-gold">2</span>/2 Steps</p>
                    </div>
            </template>
        </RightCard>
    </template>
